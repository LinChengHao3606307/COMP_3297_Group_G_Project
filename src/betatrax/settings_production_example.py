...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-(ydai7%wput-1lfb-#8clmlk2=#jd^!zks5_hjy1(2ah-6p%ua')
...
# Custom hostname extractor that removes the port
def hostname_from_request(request):
    host = request.get_host().split(':')[0].lower()   # removes :8000
    return host

# Tell django-tenants to use our custom function
TENANT_HOSTNAME_FROM_REQUEST = 'src.settings.hostname_from_request'
