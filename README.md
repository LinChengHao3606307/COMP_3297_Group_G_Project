...
This project is a software that links beta testers to developers and product owners.
...
```
        ...
        'PORT': '5432',
```
Follow the order below and run all commands for opening django's default debug server
```bash
...
4. go to http://yourdomain.localhost:8000/users/register/ to create new users

### Instructions and API references
API references are provided in [schema.yaml](/src/schema.yaml). For online webpage view, please go to [public hosting](#public-hosting) section. 
